...
int main() {
    ...
    //  ANOTHER TESTCASE. UNCOMMENT TO CHECK THAT EVEN WITHIN THIS MAIN, IF THERE ARE MULTIPLE USES OF PKEY_SET
    //  LEGITIMATE AS WELL AS ILLEGITIMATE, BOTH ARE HANDLED.
